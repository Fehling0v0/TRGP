...
let ext = seal.ext.find('OldMaid1');
if (!ext) {
  ext = seal.ext.new('OldMaid1', 'Fehling0v0', '1.0.0');
  seal.ext.register(ext);
}

let extEnabled1 = false;
...
function handleDrawCard(ctx, msg, player) {
  ...
  const drawnCard = opponentHand.splice(randomIndex, 1)[0];
